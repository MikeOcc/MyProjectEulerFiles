...
# 110000000, +163023, 350000,15921.25

retturns=350000
numturns = retturns +700000 # 150000
print "Cardano Numbers for limit with turns:", lim, numturns
#for i in xrange(10000149,10010000):   #numturns):
for i in xrange(retturns,numturns):   #numturns):
