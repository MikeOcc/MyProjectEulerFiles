...
class HelloButton(Button):
    def __init__(self, parent = None, **config):
        ...
        self.msg = "You pressed the exit Button"
...
class Hello(Frame):
    ...
    def make_me_some_widgets(self):
        widget1 = Button(self, text = "Generate", command = self.message)
        widget1.pack(side = LEFT)
        widget2 = HelloButton(self, text = "Exit", command = HelloButton.printextra)
        widget2.pack()
    def message(self):
